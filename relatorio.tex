...
O ambiente de desenvolvimento é destinado à plataforma mobile, As práticas e 
experiencias relatadas serão diretamente relacionadas a linguagem de programação
javascript e a biblioteca React native, porém coexistindo com as linguagem php,
com a biblioteca Laravel, SQL e noções sobre AWS onde se encontra a 
infraestrutura. 
